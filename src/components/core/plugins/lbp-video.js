 ...
 * @LastEditTime: 2024-07-01 15:12:15
...
export default {
  ...
  props: {
    ...
    loop: PropTypes.boolean({ defaultValue: true, label: '循环播放' }),
    controls: PropTypes.boolean({ defaultValue: false, label: '控制面板' }),
    muted: PropTypes.boolean({ defaultValue: true, label: '静音' })
  },
  watch: {
    src () {
      this.appendIframe()
